...
df_matrics.loc[len(df_matrics)]=['Model_3 (Random Forest)','Using numerics + categorical columns (Scaling and Encoding)',train_rmse,val_rmse,test_rmse]
df_matrics.loc[len(df_matrics)]=['Model_3 (Linear Regression)','Using numerics + categorical columns (Scaling and Encoding)',train_rmse_lr, val_rmse_lr, test_rmse_lr]
