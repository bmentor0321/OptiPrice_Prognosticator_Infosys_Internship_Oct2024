...
X = data.drop(["Historical_Cost_of_Ride", "Location_Category", "Customer_Loyalty_Status", "Time_of_Booking", "Vehicle_Type"], axis=1)
y = data["Historical_Cost_of_Ride"]

#One-hot encoding for 'Average rating class'
X_encoded = pd.get_dummies(X, columns=['Average_Ratings_Class'])
...
test_results.to_csv(os.path.join(RESULTS_DIR, 'test_results_with_error_3.5.csv'), index=False)