...
X = data.drop(["Historical_Cost_of_Ride", "Customer_Loyalty_Status", "Time_of_Booking", "Vehicle_Type", "Average_Ratings_Class"], axis=1)
y = data["Historical_Cost_of_Ride"]

#One-hot encoding for `Location_Category`
X_encoded = pd.get_dummies(X, columns=['Location_Category'])
...
test_results.to_csv(os.path.join(RESULTS_DIR, 'test_results_with_error_3.1.csv'), index=False)
