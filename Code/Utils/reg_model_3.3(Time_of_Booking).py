...
X = data.drop(["Historical_Cost_of_Ride", "Location_Category", "Customer_Loyalty_Status", "Vehicle_Type", "Average_Ratings_Class"], axis=1)
y = data["Historical_Cost_of_Ride"]

#One-hot encoding for 'Time of booking'
X_encoded = pd.get_dummies(X, columns=['Time_of_Booking'])
...
test_results.to_csv(os.path.join(RESULTS_DIR, 'test_results_with_error_3.3.csv'), index=False)